...
/**
 * Created by ammonrees on 12/17/14.
 */
public class SlideToUnlock extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        String text = attributes.getString(R.styleable.SlideToUnlockView_slidertext);
        ...
        track = attributes.getDrawable(R.styleable.SlideToUnlockView_slidertrack);
        attributes.recycle();
